...
enum class Format
{
    ...
    RGBP, //Red, Green, Blue in planar format
    RGBAP, //Red, Green, Blue, Alpha in planar format
    BGR, //Blue, Green, Red
    BGRA, //Blue, Green, Red, Alpha
    BGRP, //Blue, Green, Red in planar format
    BGRAP, //Blue, Green, Red, Alpha in planar format
    YUV,
    YUV420,
    YUV420P, //3 planes luma chroma U, chroma V
    YUV420SP //2 planes luma and chroma, UV is packed
};
...
IMGLIB_EXPORT Format channelsToFormat(size_t channels);
...
IMGLIB_EXPORT Depth bitsToDepth(size_t bits);
...
template<>
constexpr size_t channels<Format::YUV420>() { return 3; }
template<>
constexpr size_t channels<Format::YUV420P>() { return 3; }
template<>
constexpr size_t channels<Format::YUV420SP>() { return 3; }
...
template<>
constexpr size_t sizeOfDepth<Depth::Float16>() { return sizeof(uint16_t); }
...
IMGLIB_EXPORT size_t imageStride(Format format, Depth depth, size_t width);
...
template<>
inline bool comparePixel<Format::GreyScale, Depth::Float16>(uint8_t *src1Data, uint8_t *src2Data) { return (*(uint16_t *)(src1Data))==(*(uint16_t *)(src2Data)); }
...
template<>
inline bool comparePixel<Format::RA, Depth::Float16>(uint8_t *src1Data, uint8_t *src2Data)
{
    uint16_t *src1Float=(uint16_t *)src1Data;
    uint16_t *src2Float=(uint16_t *)src2Data; 
    return (src1Float[0]==src2Float[0])&&(src1Float[1]==src2Float[1]);
}

template<>
inline bool comparePixel<Format::RGB, Depth::Float16>(uint8_t *src1Data, uint8_t *src2Data)
{
    uint16_t *src1Float=(uint16_t *)src1Data;
    uint16_t *src2Float=(uint16_t *)src2Data;
...
template<>
inline bool comparePixel<Format::RGBA, Depth::Float16>(uint8_t *src1Data, uint8_t *src2Data)
{
    uint16_t *src1Float=(uint16_t *)src1Data;
    uint16_t *src2Float=(uint16_t *)src2Data;
