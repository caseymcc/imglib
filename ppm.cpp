...
void writePpmRGB32f(ImageWrapper &image, FILE *file);
void writePpmRGBA(ImageWrapper &image, FILE *file);
void writePpmRGBA32f(ImageWrapper &image, FILE *file);
...
void writePpmRGB32f(ImageWrapper &image, FILE *file)
{
    ...
    for(size_t y=0; y<image.height(); ++y)
    {
        for(size_t x=0; x<image.width()*3; ++x)
        {
            float &value=*data;
...
void writePpmRGBA32f(ImageWrapper &image, FILE *file)
{
    ...
    for(size_t y=0; y<image.height(); ++y)
    {
        for(size_t x=0; x<image.width()*4; ++x)
        {
            float &value=*data;
